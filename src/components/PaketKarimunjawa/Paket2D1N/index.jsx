...
const Paket2D1N = () => {
    ...
    return (
        <div className="bg-white py-44 flex flex-col items-center">
            ...
            ></div>
            <h1 className="-mt-96 text-white text-5xl text-center">{t('content.packageTitle2D1N')}</h1>
            <div className="bg-[#2db0f4] h-[3px] w-32 my-3"></div>
            <h3 className="text-center px-10 md:px-28 py-12 text-white">{t('content.packageSubtitle2D1N')}</h3>
